...
namespace {
    ...
    struct BatteryHostServiceStubUnitTest {};
}
...
template class HandleTemperatureImplement<
    BatteryHostServiceStubUnitTest,
    decltype(&BatteryHostServiceStub::HandleTemperature),
    &BatteryHostServiceStub::HandleTemperature
>;
